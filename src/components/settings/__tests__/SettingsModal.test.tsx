...
const tauriMock = vi.hoisted(() => ({
  getAppLogLevel: vi.fn(),
  updateAppLogLevel: vi.fn(),
  getSettings: vi.fn(),
...
describe('SettingsModal', () => {
  beforeEach(() => {
    ...
    tauriMock.getAppLogLevel.mockResolvedValue('info')
    tauriMock.updateAppLogLevel.mockResolvedValue(undefined)
  ...
  it('loads and persists the app log level from the about panel', async () => {
    tauriMock.getAppLogLevel.mockResolvedValue('debug')
    ...
    expect(tauriMock.getAppLogLevel).toHaveBeenCalledTimes(1)
    expect(tauriMock.updateAppLogLevel).toHaveBeenCalledWith('warn')
  })
