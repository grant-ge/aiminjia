...
>(({ className, orientation = 'vertical', ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    className={cn(
      ...
      orientation === 'vertical' && 'h-full w-2.5 border-l border-l-transparent p-[1px] border-border',
      orientation === 'horizontal' && 'h-2.5 flex-col border-t border-t-transparent p-[1px] border-border',
      className,
    )}
    {...props}
  >
