  ...
  return (
    <span className={cn('relative inline-flex min-w-36 shrink-0', disabled && 'opacity-60')}>
      <select
        ...
        className={cn(
          'h-9 w-full appearance-none rounded-md border border-border bg-muted py-0 pl-4 pr-9 text-sm font-semibold text-foreground outline-none transition-colors',
