...
export function Switch({
  ...
  return (
    <Button unstyled
      ...
      onClick={handleClick}
      className={cn(
        'relative h-6 w-11 shrink-0 rounded transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
        size === 'sm' && 'h-5 w-9',
    ...
    >
      <span
        className={cn(
          ...
          'absolute left-0.5 top-0.5 h-5 w-5 rounded bg-white shadow transition-transform',
          size === 'sm' && 'h-4 w-4',
