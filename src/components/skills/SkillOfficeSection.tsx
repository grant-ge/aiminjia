...
export function SkillOfficeSection({ categoryBar, children, layout = 'grid', title = '全部技能' }: SkillOfficeSectionProps) {
  return (
    <section className="flex min-w-0 flex-col gap-3">
      ...
      <div className={layout === 'list'
        ...
        : 'grid min-w-0 grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'
      }>
        {children}
      </div>
    </section>
