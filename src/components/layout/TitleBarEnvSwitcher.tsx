    ...
    <span className="mr-2" onMouseDown={(e) => e.stopPropagation()}>
      <AppDropdown
        ...
        trigger={
          <Button unstyled
            type="button"
            className="inline-flex h-[20px] min-h-[20px] items-center gap-0.5 rounded bg-[var(--color-semantic-green)] px-1.5 text-[11px] font-semibold leading-[20px] tracking-wide text-primary-foreground shadow-[var(--shadow-sm)] transition-[filter] hover:brightness-95"
          >
            {currentLabel}
