...
export function UpdateAvailableLink() {
  ...
  return (
    <Button unstyled
      ...
      className="mr-2 flex h-6 shrink-0 items-center gap-1.5 rounded px-2 text-xs font-medium text-[rgba(var(--sidebar-foreground-rgb),0.80)] transition-colors hover:bg-[rgba(var(--sidebar-accent-rgb),0.70)] hover:text-sidebar-foreground"
    >
      <span
