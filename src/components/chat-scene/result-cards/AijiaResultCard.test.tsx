...
describe('aijia result cards in assistant markdown', () => {
  ...
  it('renders a skill-created card and opens skill detail', () => {
    ...
    expect(card?.querySelector('.lucide-blocks')?.parentElement).toHaveClass('bg-muted/45')
    expect(card?.querySelector('.lucide-blocks')?.parentElement).toHaveClass('text-muted-foreground')
    expect(card?.querySelector('.lucide-sparkles')).not.toBeInTheDocument()
    expect(card?.querySelector('.lucide-blocks')).toBeInTheDocument()
  ...
  it('renders the schedule card as a compact white bordered object card', async () => {
    ...
    expect(card).toHaveClass('shadow-none')
    expect(card).toHaveClass('rounded-md')
    expect(card?.querySelector('.lucide-calendar-clock')?.parentElement).toHaveClass('bg-muted/45')
    expect(card?.querySelector('.lucide-calendar-clock')?.parentElement).toHaveClass('text-muted-foreground')
