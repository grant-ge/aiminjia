...
export function ExpertTeamDetailDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[86vh] max-w-[820px] overflow-hidden p-0" data-aijia-expert-team-detail>
        ...
        <div className="flex max-h-[86vh] flex-col overflow-hidden">
          <div className="flex items-start gap-5 border-b border-border bg-card px-6 py-5 pr-16">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">{team.tagline}</p>
            </div>
          </div>
