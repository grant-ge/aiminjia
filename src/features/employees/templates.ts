...
export const BUILTIN_TEMPLATES: EmployeeTemplate[] = [
  ...
  },
  {
    ...
    systemPromptExtra: [
      ...
      '',
      '## 怎么做',
      '你的具体工作流由 `skill-creator` 技能定义。**对话开始时，主动用 `Skill` 工具加载 `skill-creator`，然后严格按它的指引推进。** 别凭记忆复述步骤——以 skill-creator 的最新版本为准。',
      '',
      '## 你不是什么',
      ...
      '⑦ 落盘：按 skill-creator 的 install 指引把 SKILL.md 安装到当前用户技能目录',
      '',
      '## SKILL.md 写作模板（最终以 skill-creator 提供的为准）',
      '```',
      '---',
