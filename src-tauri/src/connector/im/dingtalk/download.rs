...
use super::token::{get_access_token, TokenCache};
...
mod tests {
    ...
    async fn download_dedup_when_same_content() {
        ...
        let first = downloader
            .download("code-1", "robot-1", "a.bin")
            .await
            .unwrap();
        let second = downloader
            .download("code-2", "robot-1", "a.bin")
            .await
            .unwrap();
