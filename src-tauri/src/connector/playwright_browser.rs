...
impl PlaywrightBrowser {
    ...
    pub async fn extract_table_data(
        ...
        info!(
            "[Playwright] extract_table_data: save_path={}, max_pages={:?}, page_size={:?}",
        ...
        info!(
            "[Playwright] extract_table_data complete: {} rows, {} pages, saved to {}",
    ...
    pub async fn extract_with_pagination(
        ...
        info!(
            "[Playwright] extract_with_pagination complete: {} rows, {} pages",
