...
| `docs/decisions/runtime-decisions.md` | Runtime、LLM gateway、token/cost、bundled runtime、auth 等稳定决策 |
...
| Managed runtime | `scripts/ensure-bundled-runtime.mjs`, `scripts/prepare-bundled-runtime.*`, `src-tauri/src/runtime/dependencies/*`, `src/components/settings/panels/RuntimePanel.tsx` |
