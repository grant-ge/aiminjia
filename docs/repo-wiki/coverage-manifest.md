...
| Prompt / context / compaction / cost accounting | strong | `.understand-anything/enhancements/prompt-context-compaction-cost.json`, `docs/repo-wiki/runtime-map.md`, `docs/repo-wiki/frontend-map.md` | 预算阈值生产注入点和 cache token summary 写入缺口继续保留为已知 gap |
