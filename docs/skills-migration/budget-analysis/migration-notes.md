# budget-analysis migration notes

## 来源

- 旧目录：`src-tauri/plugins/budget-analysis`
...
- 新入口：`docs/skills-migration/budget-analysis/SKILL.md`
...
- `references/knowledge/variance_rules.json`：差异类型、常见原因、严重度阈值
- `references/knowledge/forecast_models.json`：线性外推、季节性调整、移动平均等预测方法
- `references/knowledge/cost_control.json`：常见成本管控动作和节约区间
