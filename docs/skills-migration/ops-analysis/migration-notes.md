# ops-analysis migration notes

## 来源

- 旧目录：`src-tauri/plugins/ops-analysis`
...
- 新入口：`docs/skills-migration/ops-analysis/SKILL.md`
...
- `references/knowledge/benchmarks.json`：电商、App、内容场景的转化和留存基准
- `references/knowledge/growth_playbooks.json`：曝光、转化、留存、渠道 ROI 和活跃改善策略
