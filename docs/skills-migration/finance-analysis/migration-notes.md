# finance-analysis migration notes

## 来源

- 旧目录：`src-tauri/plugins/finance-analysis`
...
- 新入口：`docs/skills-migration/finance-analysis/SKILL.md`
...
- `references/knowledge/benchmarks.json`：行业/经验基准指标
- `references/knowledge/diagnostic_models.json`：诊断模型和健康度判断框架
- `references/knowledge/rules.json`：财务比率阈值和异常判断规则
